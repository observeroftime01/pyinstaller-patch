...
- Official debugging guide: https://pyinstaller.org/en/v6.12.0/when-things-go-wrong.html
...
.. _`manual`: https://pyinstaller.org/en/v6.12.0/
.. _`Changelog`: https://pyinstaller.org/en/v6.12.0/CHANGES.html
